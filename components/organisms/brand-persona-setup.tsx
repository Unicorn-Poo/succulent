      ...
      <div className="text-center py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          {defaultPersonas.map(persona => (
            <div
              key={persona.id}
              className="p-4 border border-border rounded-lg hover:border-brand-mint dark:hover:border-brand-seafoam cursor-pointer transition-colors dark:bg-muted"
            ...
            >
              ...
              <div className="flex items-center space-x-2 text-xs">
                <span className="px-2 py-1 bg-brand-mint/20 dark:bg-brand-seafoam/20 text-brand-seafoam dark:text-brand-mint rounded-full">
                  {persona.voice.tone}
                </span>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="p-4 bg-brand-mint/10 dark:bg-brand-seafoam/20 border border-brand-mint/40 dark:border-brand-seafoam/40 rounded-lg">
              <h4 className="font-medium text-brand-seafoam dark:text-brand-mint mb-2">🚀 Quick Setup (30 seconds)</h4>
              <p className="text-sm text-brand-seafoam dark:text-brand-mint dark:text-brand-mint mb-3">Just fill in the basics and get a simple prompt</p>
              <div className="space-y-3">
                <Input
      ...
      {showPrompt && !showExamplePostsPrompt && (
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-3 p-3 bg-brand-mint/10 dark:bg-brand-seafoam/20 border border-brand-mint/40 dark:border-brand-seafoam/40 rounded-lg">
  ...
  const renderEditInterface = () => {
    ...
    return (
      <div className="bg-card rounded-lg shadow-sm border dark:border-border p-6">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-4 bg-brand-mint/10 dark:bg-brand-seafoam/20 rounded-lg">
                <h4 className="font-medium text-brand-seafoam dark:text-brand-mint">Voice Tone</h4>
                <p className="text-2xl font-bold text-brand-seafoam dark:text-brand-mint capitalize">{currentPersona.voice.tone}</p>
              </div>
              ...
              <div className="p-4 border dark:border-border rounded-lg">
                ...
                <div className="flex flex-wrap gap-2">
                  {currentPersona.messaging.contentPillars.map(pillar => (
                    <span key={pillar} className="px-3 py-1 bg-brand-mint/20 dark:bg-brand-seafoam/20 text-brand-seafoam dark:text-brand-mint rounded-full text-sm">
                      {pillar}
                    </span>
                  ))}
                </div>
        ...
        <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-brand-mint/40 dark:border-brand-seafoam/40 rounded-lg">
          <h4 className="font-medium text-brand-seafoam dark:text-brand-mint mb-2">🤖 AI Integration</h4>
          <p className="text-sm text-brand-seafoam dark:text-brand-mint dark:text-brand-mint">

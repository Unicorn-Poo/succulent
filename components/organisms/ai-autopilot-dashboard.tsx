        ...
        <div className="p-6">
          ...
          {generatedContent && !isGenerating && (
            <div className="space-y-4">
              ...
              {/* Scheduling Info */}
              <div className="flex items-center justify-between p-3 bg-brand-mint/10 dark:bg-brand-seafoam/20 rounded-lg border border-brand-mint/40 dark:border-brand-seafoam/40">
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-brand-seafoam dark:text-brand-mint" />
                  <div>

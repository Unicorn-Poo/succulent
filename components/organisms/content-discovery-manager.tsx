              ...
              .map(item => (
                <div
                  ...
                  className={`p-4 border rounded-lg ${
                    selectedContent.includes(item.id) ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
                  }`}
                >
              ...
              <div className="mb-3">
                <div className="flex flex-wrap gap-2">
                  {topic.hashtags.map(hashtag => (
                    <span key={hashtag} className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-sm">
                      {hashtag}
                    </span>
                  ))}
                </div>
          ...
          <div className="space-y-4">
            {feeds.map(feed => (
              <div key={feed.id} className="p-4 border rounded-lg">
                ...
                <p className="text-sm text-gray-700 mb-3">{feed.description}</p>

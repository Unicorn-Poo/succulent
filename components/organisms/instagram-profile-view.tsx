  ...
  return (
    <div className="max-w-4xl mx-auto bg-card">
      ...
      <div className="p-6 border-b border-border">
        ...
        <div className="flex items-start gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="mb-4">
              ...
              {profileInfo?.website && (
                <Link href={profileInfo.website} target="_blank" className="text-brand-seafoam dark:text-brand-mint hover:underline">
            ...
            <div className="flex items-center gap-2">
              {onCreatePost && (
                <Button
                  ...
                  className="flex-1 bg-brand-seafoam hover:bg-brand-seafoam text-white"
                >
        ...
        {/* Sync Results */}
        {syncResults && (
          <div className="mt-4 p-3 bg-brand-mint/10 dark:bg-brand-seafoam/20 border border-brand-mint/40 dark:border-brand-seafoam/40 rounded-lg">

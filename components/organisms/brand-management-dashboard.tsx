          ...
          <div className="space-y-4">
            {brandSettings.templates.map(template => (
              <div key={template.id} className="p-4 border rounded-lg">
                ...
                <p className="text-gray-800 mb-3 whitespace-pre-wrap">{template.content}</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(brandSettings.guidelines.postingFrequency).map(([platform, frequency]) => (
                <div key={platform} className="text-center">
                  <p className="text-2xl font-bold text-blue-600">{frequency}</p>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="p-4 bg-green-50 rounded-lg text-center">
              ...
              <p className="text-sm text-green-700">Hashtag Consistency</p>
            </div>
            <div className="p-4 bg-purple-50 rounded-lg text-center">
              ...
              <p className="text-sm text-purple-700">Voice Consistency</p>
            </div>
            <div className="p-4 bg-yellow-50 rounded-lg text-center">
              ...
              <p className="text-sm text-yellow-700">Visual Consistency</p>
            </div>
          </div>

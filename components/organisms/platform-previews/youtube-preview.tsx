...
export default function YouTubePreview({ post, account }: YouTubePreviewProps) {
  ...
  return (
    <div className="max-w-md mx-auto bg-card border border-border rounded-lg overflow-hidden">
      {/* Status Badge */}
      ...
      <div className="relative">
        <div className="aspect-video bg-gradient-to-br from-red-100 to-red-200 flex items-center justify-center">
          <div className="text-center text-red-600 dark:text-red-400">
            ...
            <p className="text-sm font-medium text-foreground">Video Thumbnail</p>
          </div>
        </div>

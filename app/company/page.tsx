...
export default function CompanyDashboard() {
  ...
  const isCreator = me?.profile?.email && creatorEmails.includes(me.profile.email);
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <Text size="4" color="gray">Owner dashboard for managing Succulent</Text>
          </div>
      ...
      <Tabs.Root defaultValue="overview" className="w-full">
        <Tabs.List className="mb-6">
          ...
          <Tabs.Trigger value="admin-groups" className="flex items-center gap-2">
            <Shield size={16} />
            Admin Groups
          </Tabs.Trigger>
          <Tabs.Trigger value="system-health" className="flex items-center gap-2">
            <Database size={16} />
            System Health
          </Tabs.Trigger>
          ...
          <Card key={index}>
            <Box p="6">
              <div className="text-center">
                ...
                <Text size="1" color="gray" className="mt-1">{stat.description}</Text>
              </div>
            </Box>
          </Card>
        ))}
      ...
      <Card>
        <Box p="6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge color={companyStats.systemHealth === 'good' ? 'green' : 'red'}>
              {companyStats.systemHealth === 'good' ? '✅ Healthy' : '⚠️ Issues'}
            </Badge>
          </div>
        ...
        <Box p="6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <Text size="2" color="gray">Manage administrative access to Succulent</Text>
            </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge size="1" color="gray">{group.memberCount} members</Badge>
                      <Badge size="1" color="blue">{group.permissions.length} permissions</Badge>
                    </div>
                  </div>
                </div>
                <div className="flex gap-2">
                  <Button size="1" variant="outline">Manage</Button>
                  <Button size="1" variant="outline" color="red">Delete</Button>
                </div>
              </div>
            ))}
          </div>
...
function SystemHealthTab({ account }: { account: MyAppAccountLoaded }) {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <Box p="6">
          <Heading size="5" className="mb-6">System Health Monitoring</Heading>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {Object.entries(systemMetrics).map(([key, value]) => (
              <div key={key} className="p-4 border rounded-lg text-center">
                ...
                <Text size="4" weight="bold" className="block mt-1">{value}</Text>
              </div>
            ))}
          </div>
        </Box>
      ...
      <Card>
        <Box p="6">
          <Heading size="5" className="mb-4">Recent System Events</Heading>
          <div className="space-y-3">
            {[
              { time: '2 minutes ago', event: 'Database backup completed', status: 'success' },
              { time: '1 hour ago', event: 'New user registration spike detected', status: 'info' },
              { time: '3 hours ago', event: 'Payment processor sync completed', status: 'success' },
              ...
              <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100">
                <div>
                  ...
                  <Text size="2" color="gray">{event.time}</Text>
                </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Text size="2" color="gray">Enhanced security for admin accounts</Text>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Text size="2" color="gray">All sensitive data encrypted at rest</Text>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Text size="2" color="gray">Real-time threat detection</Text>
                </div>
              </div>
...
function CompanySettingsTab({ account }: { account: MyAppAccountLoaded }) {
  return (
    <div className="space-y-6">
      <Card>
        <Box p="6">
          <Heading size="5" className="mb-6">Company Settings</Heading>
          
          <div className="space-y-6">
            <div>
              <Text weight="medium" className="mb-2 block">Company Information</Text>
            ...
            <div>
              <Text weight="medium" className="mb-2 block">System Configuration</Text>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <Text>Allow New User Registrations</Text>
                    <Text size="2" color="gray">Control whether new users can sign up</Text>
                  </div>
                  <Button variant="outline" size="1">Enabled</Button>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <Text>Maintenance Mode</Text>
                    <Text size="2" color="gray">Temporarily disable access for maintenance</Text>
                  </div>
                  <Button variant="outline" size="1">Disabled</Button>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <Text>Debug Logging</Text>
                    <Text size="2" color="gray">Enhanced logging for troubleshooting</Text>
                  </div>
                  <Button variant="outline" size="1">Disabled</Button>
                </div>
              </div>

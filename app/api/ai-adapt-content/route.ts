...
const PLATFORM_LIMITS: Record<string, { maxChars: number; description: string }> = {
  ...
  tiktok: { maxChars: 2200, description: "TikTok - Engaging caption, can be longer, 3-10 hashtags" },
  threads: { maxChars: 10000, description: "Threads - conversational, can be longer-form content" },
